<template>
  <div>
    <b-form @submit="onSubmit" @reset="onReset" v-if="show">
                  ...
                  <div v-if="!goal.ownGoal">
                    <b-row v-if="isSameTeam(goal,'A')" class="my-1">
                      <b-col cols="12">
                        ...
                        <label v-else-if="goal.penalty">(Penalidade)</label>
                      </b-col>
                    </b-row>
      ...
      <b-card class="m-3">
        <b-row>
          <b-form-group class="mb-3 mx-3" id="input-group-0" label="Equipa:" label-for="input-0">
            <b-form-checkbox
              @change="setTeamId"
              id="input-0"
              v-model="teamLetter"
          ...
          <b-form-group class="mb-3 ml-3" id="input-group-1" label="Tempo:" label-for="input-1">
            <b-form-timepicker required id="input-1" v-model="form.time"></b-form-timepicker>
          </b-form-group>
          <b-form-group class="mb-3 ml-3" id="input-group-2" label="Marcador:" label-for="input-2">
            <b-form-select
          ...
          <b-form-group class="mb-3 ml-3" id="input-group-4" label="Tipo:" label-for="input-4">
            <b-row>
              <b-form-checkbox
                class="mx-3"
                value="O"
              ...
              <b-form-checkbox value="P" unchecked-value="N" v-model="form.type">Penalidade</b-form-checkbox>
            </b-row>
          </b-form-group>
          <b-form-group
            class="mb-3 ml-3"
    ...
    <client-only>
      <b-row class="m-3">
        ...
        <b-card class="mr-2" v-for="goal in goals" :key="goal.id" :header="goal.id">
          <pre class="m-0">{{ goal }}</pre>
        </b-card>
      </b-row>
    </client-only>
  </div>
...
export default {
  ...
  async mounted() {
    try {
      ...
      this.form.time = this.match.beginTime.toDate().toLocaleTimeString()
